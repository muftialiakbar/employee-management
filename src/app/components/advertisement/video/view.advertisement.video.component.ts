...
@Component({
  templateUrl: './view.advertisement.video.component.html'
})

export class ViewAdvertisementVideoComponent implements OnInit{
  public datas: AdvertisementVideoInterface[] = [];
  public pDatas : AdvertisementInterface = [] as any;
  public dataPage: any = {};
  public list: AdvertisementVideoInterface = [] as any;
  public pid: number;
