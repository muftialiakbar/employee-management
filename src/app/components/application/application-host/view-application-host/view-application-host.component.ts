...
@Component({
  selector: 'app-view-application-host',
  templateUrl: './view-application-host.component.html',
  styleUrls: ['./view-application-host.component.scss']
})
export class ViewApplicationHostComponent implements OnInit {
