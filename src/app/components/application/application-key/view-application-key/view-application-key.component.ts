...
@Component({
  selector: 'app-view-application-key',
  templateUrl: './view-application-key.component.html',
  styleUrls: ['./view-application-key.component.scss']
})
export class ViewApplicationKeyComponent implements OnInit {
